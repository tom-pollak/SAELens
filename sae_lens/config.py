...
class CacheActivationsRunnerConfig:
    ...
    Args:
        ...
        dataset_num_rows (int): Number of rows to process. Set to a large number to process the entire dataset.
    ...
    def __post_init__(self):
        ...
        self.total_training_tokens = self.dataset_num_rows * self.sliced_context_size
